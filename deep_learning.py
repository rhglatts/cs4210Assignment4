...
# FILENAME: deep_learing.py
# SPECIFICATION: Tests hidden layers, numbers neurons, and learning rate and prints out the best model 
# so far each iteration. Plots the learning curves of the final best model at the end.
...
for layer in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for neurons in n_neurons:                      #looking or the best parameters w.r.t the number of neurons
        for rate in l_rate:                  #looking or the best parameters w.r.t the learning rate
            ...
            model = build_model(layer, neurons, rate)
            ...
            accuracy = sk.accuracy_score(y_test, class_predicted)
            if accuracy > highestAccuracy:
                highestAccuracy = accuracy
                
            print("Highest accuracy so far: " + str(highestAccuracy))
            print("Parameters: " + "Number of Hidden Layers: " + str(layer) + ",number of neurons: " + str(neurons) + ",learning rate: " + str(rate))
            print()
